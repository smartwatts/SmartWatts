# SmartWatts Test Execution Report
...
#### Coverage Breakdown
- **Components**: 87-100% coverage (most components well covered)
- **Pages**: 5.31% coverage (critical gap - most pages have 0% coverage)
- **Utils**: 70.85% coverage (needs improvement)
- **Contexts**: 90-92% coverage (good)
- **Hooks**: 73-89% coverage (needs improvement)
...
- **Coverage Report**: `backend/user-service/build/reports/jacoco/test/html/index.html`

#### ✅ analytics-service
- **Status**: All tests passing
- **Tests**: 17 tests passing
- **Coverage Report**: `backend/analytics-service/build/reports/jacoco/test/html/index.html`
...
- **Action Required**: Review test assertions and fix expected vs actual values
...
- **Action Required**: Apply same fix as analytics-service
...
- Coverage reports have been generated for user-service and analytics-service
